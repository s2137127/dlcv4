...
data = dict(
    ...
    testskip=0,                   # subsample testset to preview results
...
coarse_model_and_render = dict(
    num_voxels=4024000,           # expected number of voxel
    num_voxels_base=4024000,      # to rescale delta distance
    ...
    stepsize=0.2,                 # sampling stepsize in volume rendering
)
